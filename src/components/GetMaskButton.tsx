...
export const GetMaskButton = memo<GetMaskButtonProps>(({ size }) => {
  const classname = size === 'large' ?
    "inline-flex text-lg w-60 text-white border-blue-600 bg-blue-600 px-6 py-4 text-center font-bold py-2 border-none justify-center border rounded-full cursor-pointer"
