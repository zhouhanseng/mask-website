...
const sectionConfig = [
  {
    ...
    subtitle:
      "Encrypt or set access criteria for your unique content, share only with your target audience.",
    url: MessageSvg,
  ...
  },
  {
    ...
    subtitle:
      "Launch decentralized assets freely and participate in token launches directly on Twitter.",
    url: ITOSvg,
  ...
  },
  {
    mode: { reverse: false, row: false },
    title: "Web3 Profile",
    subtitle: `Aggregate all your digital activities, including your writing history, \n NFT collection, POAPs, donation records, etc all in your own profile.`,
    url: Footprint,
  ...
  },
  {
    ...
    subtitle: `Buy and sell NFTs directly on social networks, powered by OpenSea etc. Initial NFT launches also available.`,
    url: NFTSvg,
  ...
  },
  {
    ...
    title: "File Service",
    subtitle:
      "Next generation Dropbox, Decentralized, \nPermanent, Powered by Arweave, etc.",
    url: FileSvg,
  ...
  },
  {
    ...
    title: "Fiat On-Ramp",
    subtitle:
      "Buy crypto directly via credit card or \nbank transfer in 60+ countries, \npowered by Transak.",
    url: FiatSvg,
    link: "",
  },
];
