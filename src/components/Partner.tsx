...
export const Partner = () => {
  return (
    <div className="container pb-48 sm:pb-4 mx-auto">
      ...
      <div
        className="grid grid-cols-5 max-md:grid-cols-3 gap-x-16 md:gap-x-4 sm:gap-x-2 w-10/12 md:grid-cols-5 md:max-w-6xl md:w-11/12 gap-y-8 mx-auto hoverFilter md:gap-y-8 sm:gap-y-4 justify-center">
        <StaticImage
          alt=""
