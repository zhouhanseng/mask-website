  ...
  return (
    <div className="container pb-48 sm:pb-4 mx-auto">
      ...
      <div className="grid grid-cols-5 md:grid-cols-3 sm:grid-cols-2 gap-x-16 md:gap-x-4 sm:gap-x-2 w-10/12 md:grid-cols-5 md:max-w-6xl md:w-11/12 gap-y-8 mx-auto hoverFilter md:gap-y-8 sm:gap-y-4 justify-center">
        ...
        <a href="https://bootcamp.web3.foundation/" target="_blank" rel="noopener noreferrer">
          <StaticImage
            alt="Web3 Bootcamp"
        ...
        <a href="https://makerdao.com/" target="_blank" rel="noopener noreferrer">
          <StaticImage
            alt="MakerDAO"
        ...
        <a href="https://chainide.com/" target="_blank" rel="noopener noreferrer">
          <StaticImage
            alt="ChainIDE"
        ...
        <a href="https://www.alameda-research.com/" target="_blank" rel="noopener noreferrer">
          <StaticImage
        ...
        <a href="https://nymtech.net/" target="_blank" rel="noopener noreferrer">
          <StaticImage
            alt="NYM"
